    ...
    <div className="bg-white">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="bg-gray-50 p-10 rounded-lg mb-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="bg-gray-50 p-10 rounded-lg mb-10 text-left max-w-2xl mx-auto">
          ...
          <a 
            href="mailto:contact@retentionhealth.com?subject=Pilot Discussion Request"
            className="inline-block bg-blue-600 text-white px-10 py-4 rounded font-semibold hover:bg-blue-700 text-lg"
          >
